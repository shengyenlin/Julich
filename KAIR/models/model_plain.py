...
class ModelPlain(ModelBase):
    ...
    def define_optimizer(self):
        ...
        if self.opt_train['G_optimizer_type'] == 'adam':
            ...
            self.G_optimizer = SGD(G_optim_params, lr=self.opt_train['G_optimizer_lr'],
                                   momentum=self.opt_train['G_optimizer_momentum'],
                                    weight_decay=self.opt_train['G_optimizer_wd'])            
        else:
    ...
    def define_scheduler(self):
        ...
        elif self.opt_train['G_scheduler_type'] == 'ExponentialLR':
            self.schedulers.append(lr_scheduler.ExponentialLR(self.G_optimizer,
                                                        self.opt_train['G_scheduler_gamma'],
                                                        ))
        else:
            raise NotImplementedError
