...
def main(json_path='options/train_dncnn.json'):
    ...
    # computer decrease rate for scheduler
    ...
    # Calculate the decay factor for exponential decay
    decay_factor = (final_lr / initial_lr) ** (1.0 / opt['epoch'])

    opt['train']['G_scheduler_gamma'] = decay_factor
