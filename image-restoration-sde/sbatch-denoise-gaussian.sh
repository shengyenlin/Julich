...
#SBATCH --job-name=irsde-gauss-50
...
#SBATCH --error=/p/scratch/delia-mp/lin4/experiment_result/irsde/0804-gaussian-50/error-%j.err
#SBATCH --output=/p/scratch/delia-mp/lin4/experiment_result/irsde/0804-gaussian-50/output-%j.out
...
CONFIG=codes/config/denoising-sde/options/train/ir-sde-gaussian-50.yml
...
srun python3 -m \
    ...
    --nproc_per_node=4 \
    codes/config/denoising-sde/train.py \
    -opt $CONFIG \
    --launcher pytorch
