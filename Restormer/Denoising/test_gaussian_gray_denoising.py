...
parser.add_argument('--weights_path', default='./pretrained_models/gaussian_gray_denoising', type=str, help='Path to weights')
parser.add_argument('--model_type', choices=['non_blind','blind'], type=str, help='blind: single model to handle various noise levels. non_blind: separate model for each noise level.')
