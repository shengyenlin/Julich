...
#SBATCH --job-name=restormer-universal-gauss-15
...
#SBATCH --error=/p/scratch/delia-mp/lin4/experiment_result/restormer/0803-universal-gauss-15/error-%j.err
#SBATCH --output=/p/scratch/delia-mp/lin4/experiment_result/restormer/0803-universal-gauss-15/output-%j.out
...
CONFIG=Denoising/Options/GaussianGrayDenoising_Restormer_universal_gauss_15.yml
