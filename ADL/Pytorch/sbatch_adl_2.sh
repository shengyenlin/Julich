...
#SBATCH --job-name=adl-gaussian-50-l1-loss
...
#SBATCH --error=/p/scratch/delia-mp/lin4/experiment_result/adl/0803-gaussian-50-l1-loss/error-%j.err
#SBATCH --output=/p/scratch/delia-mp/lin4/experiment_result/adl/0803-gaussian-50-l1-loss/output-%j.out
...
export EXPERIMENT="0803-gaussian-50-l1-loss"
export CHANNELS_NUM=1

srun python3 train.py \
	--EXPERIMENT ${EXPERIMENT} \
    --json-file configs/ADL_train_2.json \
    ...
    --distributed \
    > ${LOG_DIR}/${EXPERIMENT}/record_resume_0804.txt 2>&1;
