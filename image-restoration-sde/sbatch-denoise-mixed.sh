...
#SBATCH --job-name=irsde-mixed-50
...
#SBATCH --error=/p/scratch/delia-mp/lin4/experiment_result/irsde/0804-mixed-50/error-%j.err
#SBATCH --output=/p/scratch/delia-mp/lin4/experiment_result/irsde/0804-mixed-50/output-%j.out
...
CONFIG=codes/config/deraining/options/train/ir-sde-mixed-50.yml
...
srun python3 -m \
    ...
    --nproc_per_node=4 \
    codes/config/deraining/train-denoise-mixed.py \
    -opt $CONFIG \
    --launcher pytorch
